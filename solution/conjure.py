...
impolement canvas into layout
make layouts transparent or whatever
implement custom colour wheel
    - create select area class
    - create bar class
    - create slider class
    - create circle slider class
    - create colour picker class
implement layers
implement saving in file formats
'''
